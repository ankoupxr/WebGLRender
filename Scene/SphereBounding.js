...
function SphereBounding()
{
    BoundingVolume.call(this, SphereBounding);
}

SphereBounding.prototype = Object.create(BoundingVolume.prototype);


SphereBounding.prototype.setExplicit = function(center, radius)
{
...
SphereBounding.prototype.growToIncludeMesh = function(mesh)
{
...
SphereBounding.prototype.growToIncludeBound = function(bounds)
{
 ...
 * @inheritDoc
 */
SphereBounding.prototype.growToIncludeMinMax = function(min, max)
{
 ...
 * @inheritDoc
 */
SphereBounding.prototype.getRadius = function()
{
    return this._halfExtentX;
};

/**
 * Generates a new SphereBounding with the transformation matrix applied.
 */
SphereBounding.prototype.transform = function(matrix)
{
    var clone = new SphereBounding();
 ...
 * @inheritDoc
 */
SphereBounding.prototype.transformFrom = function(sourceBound, matrix)
{
 ...
 * @inheritDoc
 */
SphereBounding.prototype.intersectsConvexSolid = function(cullPlanes, numPlanes)
{
 ...
 * @inheritDoc
 */
SphereBounding.prototype.intersectsBound = function(bounds)
{
 ...
 * @inheritDoc
 */
SphereBounding.prototype.classifyAgainstPlane = function(plane)
{
 ...
 * @private
 */
SphereBounding.prototype._updateMinAndMax = function()
{
    var centerX = this._center.x, centerY = this._center.y, centerZ = this._center.z;
    var radius = this._halfExtentX;
 ...
 * @ignore
 */
SphereBounding.prototype.intersectsRay = function(ray)
{
...
SphereBounding.prototype.clone = function()
{
    var aabb = new SphereBounding();
    aabb.growToIncludeBound(this);
    return aabb;
};


export {SphereBounding };