...
function AABBBounding(){
    Bounding.call(this,AABBBounding);
}

AABBBounding.prototype = Object.create(Bounding.prototype);


AABBBounding.prototype.growToIncludeMesh = function(mesh)
{
 ...
 * @inheritDoc
 */
AABBBounding.prototype.growToIncludeBound = function(bounds)
{
 ...
 * @inheritDoc
 */
AABBBounding.prototype.growToIncludeMinMax = function(min, max)
{
    if (this._expanse === BoundingVolume.EXPANSE_INFINITE) return;
 ...
 */
AABBBounding.prototype.transform = function(matrix)
{
    var clone = new AABBBounding();
 ...
 * @inheritDoc
 */
AABBBounding.prototype.transformFrom = function(sourceBound, matrix)
{
 ...
 * @inheritDoc
 */
AABBBounding.prototype.intersectsConvexSolid = function(cullPlanes, numPlanes)
{
 ...
 * @inheritDoc
 */
AABBBounding.prototype.intersectsBound = function(bound)
{
 ...
 * @inheritDoc
 */
AABBBounding.prototype.classifyAgainstPlane = function(plane)
{
    var planeX = plane.x, planeY = plane.y, planeZ = plane.z, planeW = plane.w;
 ...
 * @ignore
 */
AABBBounding.prototype.intersectsRay = function(ray)
{
 ...
 */
AABBBounding.prototype.setExplicit = function(min, max)
{
    this._minimumX = min.x;
    this._minimumY = min.y;
    this._minimumZ = min.z;
 ...
 * @private
 */
AABBBounding.prototype._updateCenterAndExtent = function()
{
    var minX = this._minimumX, minY = this._minimumY, minZ = this._minimumZ;
    var maxX = this._maximumX, maxY = this._maximumY, maxZ = this._maximumZ;
 ...
 * @inheritDoc
 */
AABBBounding.prototype.getRadius = function()
{
...
AABBBounding.prototype.getHalfExtents = function()
{
    return new Float4(this._halfExtentX, this._halfExtentY, this._halfExtentZ, 0.0);
};

AABBBounding.prototype.clone = function()
{
    var aabb = new AABBBounding()
